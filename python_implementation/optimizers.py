...
from .paraflow import paraflow


def is_external_optimizer(optimizer):
    return optimizer in ["L-BFGS", "L-BFGS-B", "NNCG", "paraflow"]


def get(params, optimizer, learning_rate=None, decay=None, weight_decay=0, n_fine = 100):
