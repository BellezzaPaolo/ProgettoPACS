...
//     
//     public:
//         Layer(int n_input, int n_output):Paramd(n_input, n_output), grad(n_input, n_output){
...
// #endif
// 
// NOTE: Replaced by Dense<T, Activation> in Dense.hpp for autodiff compatibility.